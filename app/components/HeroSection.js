  ...
  return (
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-spans-7 place-self-center text-center sm:text-left">
          ...
          <p className="text-white text-base sm:text-lg mb-6 lg:text-xl ">
            lorem ipsum dolor sit am lorem ipsum dolor sit am lorem ipsum dolor
          </p>
          <div>
            ...
            <button className="px-1 py-1 w-full sm:w-fit rounded-full bg-transparent bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-800 text-white mt-3">
              <span className="block bg-black hover:bg-slate-400 rounded-full px-5 py-2">
                Download Resume
              </span>
            </button>
          </div>
